...
<body>
	...
	<div class="section">
		<div class="container">
			<div class="box" >
				<h3 style=" color:black;">Welcome to the Group 10 Website</h3>
			</div>
		</div>
	</div>
		<div class="section">
		<div class="container">
			<div class="box" >
				<h3 style=" color:black;">Member of Group 10 in Project 2 :</h3><br>
				...
				<h3 style=" color:black;">5. Syahlah Fadhlik Darmawan</h3><br>
				<h3 style="color: black;">Video link :</h3><br>
				<a href="https://youtu.be/gFjEjYqhk4g?si=MUf9S4zxdOhRGVR8">https://youtu.be/gFjEjYqhk4g?si=MUf9S4zxdOhRGVR8</a>
			</div>
		</div>
	</div>
	<footer>
	<div class="container">
		<h1><a href="index.php" style="color:white;"></a></h1>
